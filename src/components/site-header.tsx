  ...
  return (
    <header className="fixed top-0 z-50 w-full py-4">
      <div className="container max-w-5xl max-md:px-4">
        <div className="rounded-[27px] border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 relative overflow-hidden">
          {/* Batik Background */}
          <Image
            src={BatikBg}
          ...
          {/* Content */}
          <div className="flex items-center justify-between px-4 py-2 md:pr-2 relative z-10">
            <Link href="/">
              <Image
                src={LayersLogo}
                alt="Layers Logo"
