    ...
    return (
        <section className="py-12">
            <div className="container flex flex-col items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-6xl mb-16">
                    {CONTACT_DETAILS.map((item, idx) => (
                        <a
                            ...
                            className="group flex flex-col items-center p-6 rounded-3xl border border-neutral-200 bg-white hover:bg-neutral-50 hover:border-neutral-300 transition-all duration-300 text-center shadow-sm"
                        >
                            <div className="h-10 w-10 rounded-full bg-blue-100 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                ...
                <div className="w-full max-w-6xl rounded-3xl overflow-hidden border border-neutral-200 bg-white flex flex-col md:flex-row shadow-sm">
                    {/* Address Text */}
                    <div className="p-8 md:p-12 md:w-1/3 flex flex-col justify-center gap-6">
                    ...
                    {/* Google Map Iframe */}
                    <div className="w-full md:w-2/3 h-[300px] md:h-auto min-h-[300px] relative bg-neutral-100">
                        <iframe
