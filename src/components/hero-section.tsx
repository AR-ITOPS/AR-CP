    ...
    >
      ...
      <section className="container relative z-10">
        ...
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <h1 className="max-w-4xl text-balance font-bold text-6xl tracking-tight md:text-7xl lg:text-8xl text-neutral-200 drop-shadow-sm">
            Kepercayaan Anda, <br />
          ...
          <p className="mt-8 text-balance text-lg md:text-xl text-neutral-100 leading-relaxed font-light max-w-3xl">
